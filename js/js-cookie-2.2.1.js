...
! function(e, t) {
    "use strict";
    t.behaviors.health_health_alert = {
        attach: function(t) {
            var a = e(".view-display-id-active_health_alerts_block", t),
                l = e(".health_alert__listing_horizontal", a);
            if (l.length)
                if (navigator.cookieEnabled) {
                    var h = Cookies.get(),
                        i = [];
                    for (var n in h)
                        if (n.length > "health-alert-".length && "health-alert-" === n.substr(0, "health-alert-".length)) {
                            var r = n.substr("health-alert-".length, n.length);
                            i[i.length] = r
                        }
                    l.each(function(t, a) {
                        var l, h = e(a),
                            n = e(".health-alert__button", h);
                        if (a.hasAttribute("data-identity") && (l = a.getAttribute("data-identity")), i.length)
                            if (null !== l) {
                                var r = i.indexOf(l); - 1 !== r ? i.splice(r, 1) : (h.removeClass("hidden"), n.on("click touchstart", function(e) {
                                    var t = "health-alert-" + l;
                                    h.addClass("hidden"), Cookies.set(t, 0, { expires: 365 })
                                }))
                            } else;
                        else h.removeClass("hidden"), null !== l ? n.on("click touchstart", function(e) {
                            var t = "health-alert-" + l;
                            h.addClass("hidden"), Cookies.set(t, 0, { expires: 365 })
                        }) : n.addClass("hidden")
                    }), i.length && i.forEach(function(e) {
                        var t = "health-alert-" + e;
                        Cookies.remove(t)
                    })
                } else l.each(function(t, a) {
                    var l = e(a);
                    l.removeClass("hidden"), e(".health-alert__button", l).hide()
                })
        }
    }
}(jQuery, Drupal);;